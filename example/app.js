...
var a = new Layer({ width: 150, height: 150, x: 245, y: 250, borderRadius: 75, backgroundColor: 'rgba(255, 255, 255, 0.1)' })
var b = new Layer({ width: 150, height: 150, x: 245, y: a.maxY + 50, borderRadius: 75, backgroundColor: 'rgba(255, 255, 255, 0.3)' })
var c = new Layer({ width: 150, height: 150, x: 245, y: b.maxY + 50, borderRadius: 75, backgroundColor: 'rgba(255, 255, 255, 0.5)' })
var d = new Layer({ width: 150, height: 150, x: 245, y: c.maxY + 50, borderRadius: 75, backgroundColor: 'rgba(255, 255, 255, 0.7)' })
